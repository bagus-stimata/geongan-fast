...
from app.repository.geogan.fcompany_repo import create_fcompany, get_all_fcompany
from app.schemas.geogan.fcompany import FCompanyCreate, FCompanyResponse
from app.models.geogan.fcompany import FCompany

router = APIRouter(prefix="/api/geogan", tags=["fcompany"])
